package bdmajora.backport.world.biome.provider;
...
public class BiomeProviderNether extends BiomeProvider {
	...
	public static void init() {
		...
		brm.addRange(ModBiomes.CRIMSON_FOREST, new BiomeRange[]{new BiomeRange(0.4, 1, -1, 1, 0.0, 1.0, 0.0, 1.0)});
		brm.addRange(ModBiomes.WARPED_FOREST, new BiomeRange[]{new BiomeRange(-1, 1, 0.5, 1, 0.0, 1.0, 0.0, 1.0)});
		brm.lock();
