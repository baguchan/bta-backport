...
public class TerrainAPIPlugin implements TerrainAPI {
	...
	public void onInitialize() {
		...
		ChunkDecoratorNetherAPI.randomFeatures.addFeature(new WorldFeatureNetherFungi(ModBlocks.netherWartBlock.id, ModBlocks.crimsonStem.id, false), 1, 1F, 48, new Biome[]{ModBiomes.CRIMSON_FOREST});
		ChunkDecoratorNetherAPI.randomFeatures.addFeature(new WorldFeatureNetherFungi(ModBlocks.warpedWartBlock.id, ModBlocks.warpedStem.id, false), 1, 1F, 48, new Biome[]{ModBiomes.WARPED_FOREST});
